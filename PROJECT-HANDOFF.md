...
| Web funnel source | Event Ads LP is direct-to-WhatsApp, proof-backed, and noindex; homepage/portfolio brand and asset redesign is ready locally | Responsive manual QA, end-to-end lead test, then deploy only approved source |
...
Latest user direction on 22 Juli 2026 keeps the homepage/portfolio redesign local while its new character and asset presentation are reviewed. Active sequence is: finish documentation consistency, review the main domain locally, run responsive/CTA QA, then push/deploy only after explicit user approval. Google Ads remains OFF.
...
1. Review the latest main-domain character, complete capability wording, gallery, and proof viewer at `http://localhost:3010` plus `/portfolio`; confirm the provisional brand voice before push/deployment.
