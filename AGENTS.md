...
- Google Ads tag `AW-374076115` dan conversion label lead-start WhatsApp sudah live. Ini secondary signal; lead log sampai qualified, quote, sale, revenue, dan gross profit belum beroperasi.
- Lint tidak punya error, production build berhasil, delapan rendered smoke test lulus, dan local container sehat. Final responsive visual QA masih perlu dijalankan pada ponsel/perangkat nyata.
- Public acquisition tetap ditahan oleh intentional `noindex`, Search Console, GBP/NAP, lead-log operation, offer/capacity/admin approval, indexing decision, dan end-to-end WhatsApp verification. Google Ads tetap OFF.
