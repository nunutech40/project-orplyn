...
- Source: pernyataan owner yang disampaikan user pada 16 Juli 2026.
- Limit: produk yang bisa satuan, MOQ, batas grosir, tier harga, dan syarat reseller belum dikonfirmasi.
- Marketing implication: funnel, CRM, keyword, dan offer perlu memisahkan intent satuan dan grosir tanpa membuat harga atau MOQ palsu.
...
- Limit: belum siap traffic publik karena nomor WhatsApp nyata, domain, tracking ID, dan commercial facts belum lengkap.
...
1. Nomor WhatsApp sales, PIC, jam respons, dan SOP follow-up.
2. Produk yang bisa 1 pcs dan MOQ setiap layanan.
3. Batas serta tier harga grosir.
4. Harga mulai yang aman dipublikasikan.
5. Lead time, rush order, kapasitas, area kirim, pickup, dan kebijakan pembayaran.
6. Komposisi customer satuan vs grosir berdasarkan lead, order, omzet, gross profit, dan repeat.
7. Produk/segmen paling profitable dan paling siap kapasitas.
8. Baseline qualified lead rate, quote rate, sale rate, AOV, dan lost reasons.
9. Proof yang boleh dipublikasikan: review, testimoni, logo customer, dan case study.
10. Domain, Google Business Profile, Search Console, Analytics, dan Google Ads access.
