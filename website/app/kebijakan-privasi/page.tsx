  ...
  return (
    <>
      <section className="page-intro privacy-intro">
        ...
        <h1>Data brief dipakai untuk menanggapi kebutuhan order.</h1>
        <p>
      ...
      <article className="privacy-content">
        ...
        <p>
          ...
          deadline, status desain, serta lokasi kirim atau pickup. Saat tombol
          dikirim, website menyusun data tersebut menjadi pesan WhatsApp.
        </p>

        <h2>Data pengukuran pemasaran</h2>
        <p>
          Website dapat menyimpan sumber kunjungan, campaign, halaman masuk,
          dan pengenal iklan seperti GCLID, GBRAID, atau WBRAID. Data ini dipakai
          untuk menilai sumber lead dan hasil pemasaran ketika tag pengukuran
          sudah diaktifkan.
        </p>
        ...
        <p>
          ...
          kelayakan produksi, menindaklanjuti quotation, dan mengukur apakah
          aktivitas pemasaran menghasilkan lead atau penjualan.
        </p>

        <h2>WhatsApp dan penyimpanan</h2>
        <p>
          Ketika kamu melanjutkan ke WhatsApp, pemrosesan pesan juga mengikuti
          kebijakan platform WhatsApp. Orplyn tidak menjual data brief kepada
          pihak lain. Data operasional disimpan selama masih dibutuhkan untuk
          komunikasi order dan evaluasi bisnis.
        </p>
